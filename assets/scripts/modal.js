  ...
  modal.innerHTML = ` 
    <div class="modal__container">
            ...
            <div class="modal__info">
                ...
                <div>
                    <button class="fav_btn" onclick="addFavorite('${id}')"><img src="./assets/images/icon-fav-hover.svg" alt="fav-gif" id="icon-fav-${id}"></button>
                    <button class="download_btn" onclick="downloadGifo('${img}','${slug}')"><img src="./assets/images/icon-download.svg" alt="download-gif"></button>
                </div>
            </div>
        </div>
    `;
