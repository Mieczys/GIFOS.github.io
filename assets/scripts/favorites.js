...
const fav_icon = "./assets/images/icon-fav-sin-contenido.svg";
const fav_act_img = "./assets/images/icon-fav-active.svg";
let favoriteArray = [];
...
function removeFav(gifo) {
  ...
  eraseIconFav.setAttribute("src", "./assets/images/icon-fav-hover.svg");
